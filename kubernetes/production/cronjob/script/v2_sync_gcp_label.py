...
url = f"{APP_URL}/api/v2/gcp/label-mapping"
slack_url = (
...
try:
    ...
    if response.status_code == 200:
        ...
        slack_payload = {
            "username": f"Sync GCP Label V2 (FinOps) - {ENV}",
            "icon_emoji": ":sync:",
                    ...
                    "blocks": [
                        {
                            ...
                            "text": {
                                "type": "plain_text",
                                "text": f"GCP Label V2 FinOps Synchronization | {today_formatted}",
                                "emoji": True,
                            },
                        },
                        {"type": "divider"},
                        {
                            ...
                            "text": {
                                "type": "mrkdwn",
                                "text": "@here! Daily Synchronization GCP Label V2 has been successfully completed!",
                            },
                        },
                        {"type": "divider"},
                        {

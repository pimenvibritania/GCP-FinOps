...
RUN gcloud container clusters get-credentials mof-development-cluster --zone asia-southeast2-a --project moladin-mof-development
...
RUN gcloud container clusters get-credentials shared-development-cluster --zone asia-southeast2-a --project moladin-shared-development

...
from . import GCPProjects, GCPServices, IndexWeight
...
class GCPCosts(BaseModel):
    ...
    index_weight = models.ForeignKey(IndexWeight, on_delete=models.PROTECT, blank=False)
    ...
    def get_data(self):
        return {
            ...
            "index_weight": f"{self.index_weight.value}%",
